...
class UsuarioController extends BaseController
{
    ...
    public function usuariosFiltros(): void
    {
        $data = [
        ...
        $usuarios = $model->getUsuarioFiltros($filtros, $order, (int)$numPagina);
        $filas = $model->maxPaginas($filtros);
        $data['maxPaginas'] = ceil((int)$filas['count(*)'] / 25);
