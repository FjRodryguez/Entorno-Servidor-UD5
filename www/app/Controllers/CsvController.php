...
class CsvController extends BaseController
{
        ...
        try {
            ...
            if (empty($errors)) {
                ...
                if ($res) {
                    ...
                    $errors['municipio'] = "El registro no se pudo guardar";
                }
            }
    ...
    private function checkErrorsAltaPontevedra(array $data): array
    {
        ...
        if (empty($errors)) {
            $model = new CSVModel(self::DATA_FOLDER . 'poblacion_pontevedra.csv');
            if ($model->existeDate($data['municipio'], $data['sexo'], (int)$data['anho'])) {
                $errors['municipio'] = 'Ya existe un registro con el mismo municipio, sexo y año';
            }
        }
