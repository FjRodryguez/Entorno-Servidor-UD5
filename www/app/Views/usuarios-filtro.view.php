        ...
        <div class="card-footer">
            <nav aria-label="Navegacion por paginas">
                <ul class="pagination justify-content-center">
                    <?php if($numPagina != 1){?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo $_ENV['host.folder'].'usuarios-filtro?'.$queryString.'pagina=1'; ?>" aria-label="First">
                    ...
                    <?php if($numPagina != 1){?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo $_ENV['host.folder'].'usuarios-filtro?'.$queryString.'pagina='.$numPagina-1; ?>" aria-label="Previous">
                            <span aria-hidden="true">&lt;</span>
                            <span class="sr-only">Previous</span>
                        </a>
                    </li>
                    <?php }?>
                    <li class="page-item active"><a class="page-link" href="#"><?php echo $numPagina?></a></li>
                    <?php if($numPagina != $maxPaginas){?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo $_ENV['host.folder'].'usuarios-filtro?'.$queryString.'pagina='.$numPagina+1; ?>" aria-label="Next">
                            <span aria-hidden="true">&gt;</span>
                    ...
                    <?php if($numPagina != $maxPaginas){?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo $_ENV['host.folder'].'usuarios-filtro?'.$queryString.'pagina='.$maxPaginas; ?>" aria-label="Last">
            ...
            <?php echo "Max paginas " . $maxPaginas;?>
        </div>
    </div>
    </div>
</div>
