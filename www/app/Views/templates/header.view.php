...
<body class="hold-transition sidebar-mini layout-fixed <?php echo isset($_COOKIE['dark_mode']) && $_COOKIE['dark_mode'] ? 'dark-mode' : ''; ?>">
<div class="wrapper">
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand <?php echo isset($_COOKIE['dark_mode']) && $_COOKIE['dark_mode'] ? 'navbar-dark' : 'navbar-white navbar-light'; ?>">
        <!-- Left navbar links -->
        <ul class="navbar-nav">
            <li class="nav-item">
